...
public class FormCapNhatNguoiDung extends javax.swing.JFrame {
    private final DefaultTableModel  tableModel = new DefaultTableModel(); 
    public FormCapNhatNguoiDung() {
        initComponents();
        initTable();
        fillData();
    }
  ...
  // Cho phép người dùng chọn dòng trong bảng (chế độ chỉ đọc vẫn bật)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormCapNhatNguoiDung.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormCapNhatNguoiDung().setVisible(true);
            }
        });
    }
